...
contentActive = 'accordion-content--active', paddings = 40) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.setAttr = function (attr) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.getAttr = function (attrName) {
  // получение значения атриубта
  for (let i = 0; i < this.length; i++) {
    return this[i].getAttribute(attrName);
  }
};

_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.removeAttr = function (attr) {
  // удаление атрибута 
  for (let i = 0; i < this.length; i++) {
    if (!attr) {
      return this;
...
/* $('#trigger').click(() => $('#trigger').createModal({
    text: {
        title: 'Modal title #1',
        body: "Lorem, ipsum dolor sit amet consectetur adipisicing elit.Voluptatibus sed praesentium cumque minima consectetur voluptate molestias soluta non voluptates eveniet earum autem at, saepe doloremque cum provident tempore eaque velit!"
    },
    btns: {
        count: 3,
        settings : [
